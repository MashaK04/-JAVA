...
public class map15 extends JFrame {
    ...
    public map15() throws HeadlessException {
        super("Китай");
        places = new ArrayList<>();
        index = 0;
    }

    public map15(List<Place> places) {
        this.places = places;
    }
    ...
    public void addGui() {
        ...
        prevButton = new JButton("Предыдущее");
        nextButton = new JButton("Следующее");
